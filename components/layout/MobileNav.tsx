      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute inset-x-0 top-full z-20 flex flex-col items-center gap-3 border-b border-gray-200 bg-white p-5 text-center shadow-lg dark:border-gray-700 dark:bg-gray-950"
          >
            {children}
          </motion.div>
        )}
